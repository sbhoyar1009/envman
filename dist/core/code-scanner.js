...
export class CodeScanner {
    ...
    async scanDirectory(directory, options = {}) {
        ...
        const { includePatterns = this.defaultIncludePatterns, excludePatterns = this.defaultExcludePatterns, maxFiles = 1000 } = options;
     ...
     */
    findFiles(directory, includePatterns, excludePatterns, maxFiles) {
        const files = [];
        const walk = (dir) => {
     ...
     */
    shouldIgnorePath(filePath, excludePatterns) {
     ...
     */
    matchesPatterns(filePath, includePatterns) {
