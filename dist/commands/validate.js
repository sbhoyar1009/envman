 ...
 */
async function validateVariables(variables, options) {
    const errors = [];
    const warnings = [];
    const info = [];
 ...
 */
function containsHardcodedSecrets(value) {
 ...
 */
function displayResults(result, strict) {
 ...
 */
async function applyFixes(variables, result, envFile) {
